...
class Settings:
    ...
    GEOJSON_PATH_CONTINENTS = os.getenv("GEOJSON_PATH_CONTINENTS", "data/raw/五大洲/custom.geo.json")
    GEOJSON_PATH_CHINA = os.getenv("GEOJSON_PATH_CHINA", "data/geojson/中华人民共和国.geojson")
